...
[![Documentation](https://img.shields.io/badge/docs-latest-green.svg)](https://github.com/caspiankeyes/glyphs/docs)
[![Interpretability](https://img.shields.io/badge/interpretability-symbolic-purple.svg)](https://github.com/caspiankeyes/glyphs)
...
**`Note: Glyphs evolve with model cognition and do not stay deterministic`**
```python
